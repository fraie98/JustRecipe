...
A possible index is the one on the creation time of the comment, this index affect the query \emph{Last Comments}. In order to see if the index must be added or not, let analyze the result of the index analysis for this index on that query (see table \ref{table: Statistics about comment creation time index})
...
\begin{table}[htpb]
	...
	\label{table: Statistics about comment creation time index}
		\begin{tabular}{lllll}
			...
			\multicolumn{1}{l|}{\begin{tabular}[c]{@{}l@{}}ExecutionTimeMillis: 284ms\\ TotalKeysExamined: 0\\ TotalDocsExamined: 45352\end{tabular}} &
			\multicolumn{1}{l|}{\begin{tabular}[c]{@{}l@{}}ExecutionTimeMillis: 290ms\\ TotalKeysExamined: 45383\\ TotalDocsExamined: 45352\end{tabular}} &
			&
			\\ \cline{1-3}
		\end{tabular}
	\end{table}
